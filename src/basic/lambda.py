...
iterable as inputs, and returns an iterator that applies the function to each 
element of the iterable. 
    The code below uses map() to find the mean of each list in numbers to 
create the list averages.
"""
numbers = [
              [34, 63, 88, 71, 29],
              [90, 78, 51, 27, 45],
...
iterable as inputs and returns an iterator with the elements from the iterable 
